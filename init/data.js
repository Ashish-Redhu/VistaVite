...
//   const allHaveTitle = sampleListings.every(listing => 'title' in listing);

// console.log(allHaveTitle); // Output will be either true or false

  // Here we wrapped up the array of objects "sampleListings" in an object named as "data". It is a better way to export if we want to export multiple things.
